		...
		<div id="list-pagamento" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="pagamento.aluno.label" default="Aluno" /></th>
					
						<g:sortableColumn property="datapg" title="${message(code: 'pagamento.datapg.label', default: 'Datapg')}" />
					
						<g:sortableColumn property="mensalidade" title="${message(code: 'pagamento.mensalidade.label', default: 'Mensalidade')}" />
				...
				<g:each in="${pagamentoInstanceList}" status="i" var="pagamentoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${pagamentoInstance.mensalidade}" /></td>
