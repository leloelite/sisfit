...
<html>
	...
	<body>
		...
		<div id="show-modalidade" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:modalidadeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${modalidadeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
