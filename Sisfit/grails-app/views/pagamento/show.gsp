		...
		<div id="show-pagamento" class="content scaffold-show" role="main">
			...
			<ol class="property-list pagamento">
				...
				<li class="fieldcontain">
					<span id="data-label" class="property-label"><g:message code="pagamento.data.label" default="Data" /></span>
					
						<span class="property-value" aria-labelledby="data-label"><g:formatDate date="${pagamentoInstance?.data}" /></span>
