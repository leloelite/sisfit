	...
	<body>
		...
		<div id="show-pessoa" class="content scaffold-show" role="main">
			...
			<ol class="property-list pessoa">
				...
				<g:if test="${pessoaInstance?.data}">
				<li class="fieldcontain">
					<span id="data-label" class="property-label"><g:message code="pessoa.data.label" default="Data" /></span>
					
						<span class="property-value" aria-labelledby="data-label"><g:formatDate date="${pessoaInstance?.data}" /></span>
				...
				<g:if test="${pessoaInstance?.observacoes}">
				<li class="fieldcontain">
					<span id="observacoes-label" class="property-label"><g:message code="pessoa.observacoes.label" default="Observacoes" /></span>
					
						<span class="property-value" aria-labelledby="observacoes-label"><g:fieldValue bean="${pessoaInstance}" field="observacoes"/></span>
