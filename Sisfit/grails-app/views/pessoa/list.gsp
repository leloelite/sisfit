			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="data" title="${message(code: 'pessoa.data.label', default: 'Data')}" />
					
						<g:sortableColumn property="endereco" title="${message(code: 'pessoa.endereco.label', default: 'Endereco')}" />
					
						<g:sortableColumn property="observacoes" title="${message(code: 'pessoa.observacoes.label', default: 'Observacoes')}" />
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${pessoaInstance.data}" /></td>
					
						<td>${fieldValue(bean: pessoaInstance, field: "endereco")}</td>
					
						<td>${fieldValue(bean: pessoaInstance, field: "observacoes")}</td>
